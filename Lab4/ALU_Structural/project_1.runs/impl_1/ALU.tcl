...
set rc [catch {
  ...
  set_property webtalk.parent_dir Q:/ENGG3380-Labs/Lab4/ALU_Structural/project_1.cache/wt [current_project]
  set_property parent.project_path Q:/ENGG3380-Labs/Lab4/ALU_Structural/project_1.xpr [current_project]
  set_property ip_output_repo Q:/ENGG3380-Labs/Lab4/ALU_Structural/project_1.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet Q:/ENGG3380-Labs/Lab4/ALU_Structural/project_1.runs/synth_1/ALU.dcp
...
set rc [catch {
  ...
  report_drc -file ALU_drc_routed.rpt -pb ALU_drc_routed.pb -rpx ALU_drc_routed.rpx
  report_methodology -file ALU_methodology_drc_routed.rpt -rpx ALU_methodology_drc_routed.rpx
