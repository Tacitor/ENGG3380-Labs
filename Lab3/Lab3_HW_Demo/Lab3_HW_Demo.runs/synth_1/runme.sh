...
HD_PWD='D:/ENGG_3380/ENGG3380-Labs/Lab3/Lab3_HW_Demo/Lab3_HW_Demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HW_Demo_Main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HW_Demo_Main.tcl
