...
HD_PWD='D:/ENGG_3380/ENGG3380-Labs/Lab3/Lab3_HW_Demo/Lab3_HW_Demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HW_Demo_Main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HW_Demo_Main.tcl -notrace
